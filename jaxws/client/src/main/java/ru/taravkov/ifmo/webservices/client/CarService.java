 ...
 * 
 */
@WebServiceClient(name = "CarService", targetNamespace = "http://service.client.webservices.ifmo.taravkov.ru/", wsdlLocation = "file:/Users/vtaravkov/Documents/itmo/sem10/webservices/jaxws/client/target/generated-sources/wsdl/CarService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARSERVICE_QNAME = new QName("http://service.client.webservices.ifmo.taravkov.ru/", "CarService");
    ...
    public CarWebService getCarWebServicePort() {
        return super.getPort(new QName("http://service.client.webservices.ifmo.taravkov.ru/", "CarWebServicePort"), CarWebService.class);
    }
    ...
    public CarWebService getCarWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.client.webservices.ifmo.taravkov.ru/", "CarWebServicePort"), CarWebService.class, features);
    }
